...
# MAGIC DROP TABLE IF EXISTS silver.agents;
# MAGIC DROP TABLE IF EXISTS silver.insurance_providers;
...
# MAGIC USING DELTA;
# MAGIC 
# MAGIC CREATE TABLE silver.agents(
...
# MAGIC USING DELTA;
# MAGIC 
# MAGIC CREATE TABLE silver.insurance_providers(
